...
class blogsService {
  ...
  static async getAllBlog() {
    ...
    await Sequelize.query(
      "select child.id,child.title,child.classification_id,child.parent_classification_id,child.author,child.content,child.htmlContent,child.created_time,child.updated_time,child.visit_count,child.reply_count,child.deletef,parent.name as classification_name FROM classifications parent left join blogs child on parent.id=child.classification_id where child.deletef=0"
